...
type BookingServiceClient interface {
	...
	GetAllBookings(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListBookingsResponse, error)
}
...
func (c *bookingServiceClient) GetAllBookings(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListBookingsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListBookingsResponse)
...
type BookingServiceServer interface {
	...
	GetAllBookings(context.Context, *Empty) (*ListBookingsResponse, error)
...
func (UnimplementedBookingServiceServer) GetAllBookings(context.Context, *Empty) (*ListBookingsResponse, error) {
